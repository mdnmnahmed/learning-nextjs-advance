                ...
                <div className="container px-5 py-24 mx-auto flex flex-wrap items-center">
                    <div className="lg:w-3/5 md:w-1/2 md:pr-16 lg:pr-0 pr-0">
                        <div align="center">
                            ...
                            <p className="leading-relaxed mt-4">Login and Read n number of News.</p>
                        </div>
                    </div>
                    <div className="lg:w-2/6 md:w-1/2 bg-gray-800 bg-opacity-50 rounded-lg p-8 flex flex-col md:ml-auto w-full mt-10 md:mt-0">
                        ...
                        <button className="text-white bg-blue-500 border-0 py-1 px-8 focus:outline-none hover:bg-blue-600 rounded text-lg">Login</button>
                        <p className="text-xs mt-3">Don't have an account? <Link href="/signup"><a>Signup.</a></Link></p>
                    </div>
                </div>
            </section>
        </>
